...
class DetailCharacterActivity : AppCompatActivity() {
        ...
        with(binding){
            ...
            if(data != null) {
                ...
                Glide.with(this@DetailCharacterActivity)
                    ...
                    .placeholder(com.waans.mario_world.core.R.drawable.ic_image)
    ...
    private fun setStatusFavorite(statusFavorite: Boolean) {
        binding.actionFavorite.setImageResource(
            if (statusFavorite){
                com.waans.mario_world.core.R.drawable.ic_favorite_red
            } else {
                com.waans.mario_world.core.R.drawable.ic_favorite_border_white
            }
        )
    }
